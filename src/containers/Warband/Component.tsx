...
const WarbandPage = ({
  ...
  const [general, setGeneral] = useState<WarbandGeneral>({});
  ...
  useEffect(() => {
    if (
      isSuccessGetWarbands === true &&
      !isEmpty(localWarband) &&
      !isEmpty(warband)
    ) {
      ...
      <div className={classes.form}>
        <Paper className={classes.innerForm}>
          ...
          <div ref={formScroll}>
            ...
            <RatingCard heroes={heroes} henchmen={henchmen} classes={classes} />
