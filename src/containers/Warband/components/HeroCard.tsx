...
const HeroCard = memo(
  ({
    ...
    const autoFill = newHero => {
      onValueChange({ ...hero, ...newHero }, heroId);
    };
          ...
          <Grid item className={classes.hireFieldsColumn}>
            ...
            <div className={classes.attributesContainer}>
              {attributesArr.map(attribute => {
                return (
                  <div className={classes.attributeColumn} key={attribute}>
                    <p className={classes.attributeHeader}>
                      <b>{attribute.toUpperCase()}</b>
                    </p>
                    <input
                      min="0"
                      max="10"
            ...
            <div className={classes.advancementRow}>
              <TextField
                variant="outlined"
                value={hero.exp || 0}
                onChange={handleValueChange}
            ...
            <div className={classes.advancementRow}>
              <p className={classes.advancement}>
                <b>Advancements:</b>&nbsp;
                {getHeroAdvancements(hero.exp || 0, hero.startingExp || 0)}
              </p>
            </div>
          </Grid>
          <Grid item className={classes.hireFieldsColumn}>
